...
trainstepC2 <- function(vx, vy, DataSampled, BMUsampled, Lines, Columns, Radius, toroid) {
    .Call(`_GeneralizedUmatrix_trainstepC2`, vx, vy, DataSampled, BMUsampled, Lines, Columns, Radius, toroid)
}
