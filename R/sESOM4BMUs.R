sESOM4BMUs <- function(BMUs,Data, esom, toroid, CurrentRadius,ComputeInR=FALSE,
                       Parallel=FALSE){
  ...
  if(!ComputeInR){
    if(Parallel){
      esomAngepasst=trainstepC2(esom,aux-1,newData,BMUnew-1,k, m,CurrentRadius,toroid)
    }else{
